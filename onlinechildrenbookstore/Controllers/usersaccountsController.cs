...
using onlinechildrenbookstore.Data;
using onlinechildrenbookstore.Models;

namespace onlinechildrenbookstore.Controllers
{
    public class usersaccountsController : Controller
    {
        private readonly onlinechildrenbookstoreContext _context;

        public usersaccountsController(onlinechildrenbookstoreContext context)
        {
            _context = context;
        }
        ...
        {
            SqlConnection conn1 = new SqlConnection("Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=C:\\Users\\106531\\Documents\\mynewdb3.mdf;Integrated Security=True;Connect Timeout=30");
            string sql;
