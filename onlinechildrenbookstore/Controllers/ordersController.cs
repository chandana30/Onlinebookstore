...
namespace onlinechildrenbookstore.Controllers
{
    public class ordersController : Controller
    {
        ...
        public ordersController(onlinechildrenbookstoreContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create(int bookId,int quantity)
        {
            ...
            SqlConnection conn = new SqlConnection("Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=C:\\Users\\106531\\Documents\\mynewdb3.mdf;Integrated Security=True;Connect Timeout=30");
            string sql;
